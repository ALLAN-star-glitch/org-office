      ...
      {isOpen && (
        <motion.aside
          ...
          className={`
            ...
            bg-linear-to-b from-[#E9F2FF] to-[#F8FBFF]
            border-r border-[#D3E3FF]
        ...
        >
          {/* Header */}
          <div
            className="sticky top-0 z-20 flex items-center justify-between border-b border-[#D3E3FF]
            p-4 bg-gradient-to-b from-[#E9F2FF] to-[#F8FBFF] h-16"
          ...
          <div className="p-3 border-t border-[#D3E3FF] text-[11px] text-[#8091B3] text-center">
            Powered by <span className="font-semibold text-[#165DFC]">OrgOffice</span>
          </div>
        </motion.aside>
      )}
    </AnimatePresence>
